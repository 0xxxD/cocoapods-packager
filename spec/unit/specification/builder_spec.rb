    ...
    describe 'Xcodebuild command' do
      describe 'compiler flags' do
        ...
        it "includes proper compiler flags for iOS" do
          ...
          @builder.expects(:xcodebuild).with("GCC_PREPROCESSOR_DEFINITIONS='$(inherited) PodsDummy_Pods_Builder=PodsDummy_PodPackage_Builder' -DBASE_FLAG -DIOS_FLAG", "ARCHS='$(ARCHS_STANDARD)' OTHER_CFLAGS='-fembed-bitcode -Qunused-arguments'").returns(nil)
